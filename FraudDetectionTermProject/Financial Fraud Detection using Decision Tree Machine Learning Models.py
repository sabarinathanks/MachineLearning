...
# MAGIC %md
# MAGIC # Financial Fraud Detection using Decision Tree 
# MAGIC 
# MAGIC Along with the great increase in online mobile money transactions, fraud has become increasingly rampant in recent years. Fraud is one of the major causes of great financial losses and financial institutions are advancing their capability to detect fraud.
# MAGIC The objective of this project is to develop machine learning model to detect fraud.
# MAGIC 
# MAGIC In this notebook, we will showcase the use of decision tree and  Random Forest ML models to perform financial fraud detection.
# MAGIC This project is done as a group for SCS_3253_029 Machine Learning in UofT for DataScience
# MAGIC 
# MAGIC <br/>
# MAGIC 
# MAGIC # Project Members
# MAGIC Vijayan Alagudevan <br>
# MAGIC Sabarinathan Selvaraj<br>
# MAGIC VinodH Kumar Aiyappan<br>
# MAGIC Sathish Subramanian<br>
# MAGIC 
# MAGIC ### Source Data
...
# MAGIC %md
# MAGIC We can do a rulebased model but we just assign the df.isFraud in label column
...
#we just select isfraud data to label
...
# MAGIC %md ### Create ML Pipeline using DecisionTreeClassifier
